...
// import { FacebookIcon, GithubIcon, InstagramIcon, LinkedInIcon, MailIcon } from './Icons'
import {
  FacebookIcon,
  GithubIcon,
  LinkedInIcon,
    ...
    ">
      ...
      >
        ...
        <motion.a
          target={"_blank"}
          className="w-6 mx-3"
          href="https://www.linkedin.com/in/sourabhkulkarni25"
          whileHover={{ y: -2 }}
          whileTap={{ scale: 0.9 }}
        ...
        <motion.a
          target={"_blank"}
          className="w-6 mx-3"
          href="https://github.com/sourabhk25"
          whileHover={{ y: -2 }}
          whileTap={{ scale: 0.9 }}
        ...
        <motion.a
          target={"_blank"}
          className="w-6 mr-3"
          href="https://www.instagram.com/sourkul/"
          whileHover={{ y: -2 }}
          whileTap={{ scale: 0.9 }}
