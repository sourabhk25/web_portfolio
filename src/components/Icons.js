...
export const MailIcon = ({ className, ...rest }) => (
  ...
  >
    ...
    <path
      fill="url(#a)"
      fillRule="evenodd"
      d="M0 94V26A25.948 25.948 0 0 1 26 0h68a25.948 25.948 0 0 1 26 26v68a25.948 25.948 0 0 1-26 26H26A26.012 26.012 0 0 1 0 94Z"
    />
    <path
      fill="#fff"
      fillRule="evenodd"
      d="M99 86.2a6.109 6.109 0 0 1-3 .8H24a5.83 5.83 0 0 1-3-.8l24-24 5.9 5.9a12.219 12.219 0 0 0 9.1 3.4 12.374 12.374 0 0 0 9.1-3.4l5.9-5.9Zm2.1-2.2-24-24 24-24a6.109 6.109 0 0 1 .8 3v42a4.55 4.55 0 0 1-.8 3Zm-82.3 0a6.109 6.109 0 0 1-.8-3V39a5.83 5.83 0 0 1 .8-3l24 24ZM99 33.8 66.9 65.9a9.353 9.353 0 0 1-6.9 2.6 9.353 9.353 0 0 1-6.9-2.6L21 33.8a6.109 6.109 0 0 1 3-.8h72a6.109 6.109 0 0 1 3 .8Z"
    />
  </svg>
);
